...
$(function () {
  ...
  ***************************/
    $("#contact-form").submit(function (e) {
        ...
        $.ajax({
            url: "https://docs.google.com/forms/u/0/d/e/1FAIpQLSdpZ7lAwaIKP5xy6PPhswYS1wT7W6P11dXRjLGU3DJBFQH_nA/formResponse",
            data: $(this).serialize(),
            type: "POST",
            dataType: "xml",
            success: function () {
                $("#message").text("✔ Sent Successfully!");
                $("#contact-form").trigger("reset"); // clear fields
            },
            error: function () {
                // Google Form always blocks CORS → error still means it saved.
                $("#message").text("✔ Sent Successfully!");
                $("#contact-form").trigger("reset"); // clear fields
            }
        });
